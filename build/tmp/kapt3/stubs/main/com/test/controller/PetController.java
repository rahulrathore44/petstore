...
public final class PetController {
    ...
    @io.micronaut.http.annotation.Get(value = "/findPetById/{id}")
    public final io.micronaut.http.HttpResponse<com.test.model.Pet> findPetById(@io.micronaut.http.annotation.PathVariable
    int id) {
        return null;
    }
    ...
    public final io.micronaut.http.HttpResponse<java.util.List<com.test.model.Pet>> findPetsByIdNameAndStatus(@io.micronaut.http.annotation.QueryValue
    ...
    @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.Get(value = "/findPetByIdNameAndStatus")
    public final io.micronaut.http.HttpResponse<com.test.model.Pet> findPetByIdNameAndStatus(@io.micronaut.http.annotation.QueryValue
    int id, @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.QueryValue
    java.lang.String name, @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.QueryValue
    ...
    @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.Get(value = "/findPetsByCategoryName/{categoryName}")
    public final io.micronaut.http.HttpResponse<java.util.List<com.test.model.Pet>> findPetsByCategoryName(@org.jetbrains.annotations.NotNull
    ...
    public final io.micronaut.http.HttpResponse<com.test.model.Pet> findPetByCategoryName(@org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.PathVariable
    java.lang.String categoryName) {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.Get(value = "/findPetsByCategoryIdAndName")
    public final io.micronaut.http.HttpResponse<java.util.List<com.test.model.Pet>> findPetsByCategoryIdAndName(@io.micronaut.http.annotation.QueryValue
    int id, @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.QueryValue
    ...
    public final io.micronaut.http.HttpResponse<com.test.model.Pet> findPetByCategoryIdAndName(@io.micronaut.http.annotation.QueryValue
    int id, @org.jetbrains.annotations.NotNull
    @io.micronaut.http.annotation.QueryValue
    java.lang.String name) {
        return null;
